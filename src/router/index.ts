  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'license-drug-status-log',
          meta: { title: 'สถานะการขออนุมัติใบอนุญาตนำเข้ายา', icon: 'pi pi-home' },
          component: () => import('../views/StatusLogDrug.vue'),
        },
        {
          path: 'license-materia-status-log',
          name: 'license-materia-status-log',
          meta: { title: 'สถานะการขออนุมัติใบอนุญาตนำเข้าวัตถุดิบยา', icon: 'pi pi-home' },
          component: () => import('../views/StatusLogMateria.vue'),
        },
      ],
    },
    {
